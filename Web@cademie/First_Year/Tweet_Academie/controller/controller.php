            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                switch ($_POST['page']) 
                {
                    case $_POST['page'] == "newPost":
                        $data = Posts::createPost($_POST['uid'], $_POST['content'], $_POST['image'], $_POST['hashtags'], $_POST['tags']);
                    ...
                    case $_POST['page'] == "newComment":
                        $data = Comments::addComment($_POST['uid'], $_POST['postId'], $_POST['content']);
                        return json_encode($data);
                        break;
                ...
                if (isset($_GET['page'])) {
                    switch ($_GET['page']) 
                    {
                        case $_GET['page'] == "getComments":
                            $data = Comments::getComments($_GET['postId']);
                            return json_encode($data);
                            break;
