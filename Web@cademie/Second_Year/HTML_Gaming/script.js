...
const poopooImg = createImage("img/poopoo.png");
const cafardImg = createImage("img/cafard.png");
const cafardFoodImg = createImage("img/cafard_food.png");
const motherCafardFoodImg = createImage("img/motherCafard_food.png");
const motherCafardImage = [
...
// need To Convert To Poopoo Image
class InvaderProjectile {
	constructor({ position, velocity }) {
		this.position = position;
		this.velocity = velocity;
		this.image = poopooImg;
		// Width :  30      Height :    31
		this.width = 30;
		this.height = 31;
	}
...
// need To Convert To Cafard Image
class Invader {
	constructor(position) {
		this.speed = speed;
		this.image = cafardImg;
...
// need To Convert To Big Cafard Image
class MotherInvader {
	constructor(position) {
		this.velocity = {
			x: -2,
		...
		const randCafard = Math.floor(Math.random() * 3);
		this.image = motherCafardImage[randCafard];
		// Width :  100px  , Height : 85px
		this.width = 100 * 3;
		this.height = 85 * 3;
